...
<!DOCTYPE html><!--[if IEMobile 7 ]> <html dir="ltr" lang="en-US"class="no-js iem7"> <![endif]-->
...
<!--[if IE 7]><link rel="stylesheet" href="https://www.niftywindow.com/shared/css/compiled/NiftyWindowIcons-ie7.css"><![endif]--><title>Kalyan Jewellers Catalog, Catalog for Kalyan Jewellers, Marathahalli, Bangalore</title><meta name="description" content="Kalyan Jewellers Catalog. View the Catalog, price and availability for Kalyan Jewellers in Marathahalli, Bangalore."><meta name="keywords" content="Kalyan Jewellers, Marathahalli, Bangalore, Catalog"><link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/font-awesome/4.6.3/css/font-awesome.min.css"><link rel="stylesheet" href="https://fonts.googleapis.com/css?family=Nunito"><link rel="stylesheet" href="https://fonts.googleapis.com/css?family=Open+Sans"><style amp-custom>
	...
	#variants > tbody > tr:nth-child(2n+1) > th {
...
.theme-content-bg, .nap-inner.theme-content-bg {
...
.useRealBrowser .container {
  max-width: 850px;
	margin: 0 auto;
}
.useRealBrowser .container .warning {
  color: #404040;
	font-size: 0.8em;
}
.useRealBrowser .container .upgrade {
   margin: 10px 0;
}
.useRealBrowser .container .upgrade a {
   color: #df2314;
	text-decoration: underline;
}
.useRealBrowser .container .note {
  color: #999;
	font-size: 80%;
	display: none;
}
...
.summary .phone-button span, .summary .phone-button i.fa {
   margin-left: 5px;
}
.summary p.phone-label:before {
 content: none;
}
.summary p.phone-label {
   display: none;
...
.summary p.time i.fa.fa-clock-o{
   font-size: 27px;
   margin-right: 6px;
   vertical-align: sub;
}
...
.summary p.time.open i.fa.fa-clock-o{
   color: #72c772;
}
.summary p.phone-button {
 line-height: 25px;
 float: left;
 padding: 0;
 margin: 0;
...
.header .menu-bar .menu-bar ul.nav-menu.horizontal>li {
 margin-right: 0;
 margin-left: 15px;
}
.menu-bar {
...
.menu-bar ul.nav-menu.horizontal>li {
 display: inline-block;
 margin-right: 15px;
 margin-bottom: 4px;
}
...
.menu-bar ul.nav-menu.horizontal>li.optional {
 display: none;
}
.menu-bar ul.nav-menu.horizontal>li>a {
 display: block;
 font-size: 16px;
 line-height: 30px;
 text-transform: uppercase;
}
.menu-bar ul.nav-menu.horizontal>li>a:hover {
 text-decoration: none;
}
.menu-bar ul.nav-menu.vertical {
 position: absolute;
 z-index: 10;
 background-color: #fff;
 right: 20px;
...
.menu-bar ul.nav-menu.vertical.closed {
   display: none;
}
.menu-bar ul.nav-menu.vertical.open {
   display: block;
}
.menu-bar ul.nav-menu.vertical li {
 border-top: solid 1px #e3e3e3;
}
.menu-bar ul.nav-menu.vertical li:first-child {
 border-top: none;
}
.menu-bar ul.nav-menu.vertical li a {
 display: block;
 line-height: 40px;
}
.cover {
...
.footer-snm .toc-snm a, .footer-snm .toc-snm a:hover, .footer-snm .toc-snm a:focus {
   color: #404062;
   font-size: 13px;
   text-decoration: underline;
   padding-right: 5px;
...
.footer-snm .social-icons {
   vertical-align: middle;
}
.footer-snm .social-icons ul {
   padding-left: 0;
   margin-top: 0;
       margin-bottom: 10px;
}
.footer-snm .social-icons ul li {
   display: inline-block;
   zoom: 1;
   padding-left: 16px;
}
.footer-snm .social-icons ul li .facebook-link {
   background-position: 0 0;
}
.footer-snm .social-icons ul li a {
   display: block
   width: 24px
   height: 24px;
   background-repeat: no-repeat;
   background-image: url(/shared/images/Social_Icons_Branded.png);
}
.footer-snm a {
   text-decoration: none;
   color: #606060;
...
.content .campaign-holder.card h2 {
 padding: 0 0 10px 0;
 margin: 0;
...
.content .campaign-holder.card .campaign {
 overflow: auto;
 border-top: 1px dashed #c0c0c0;
 position: relative;
}
.content .campaign-holder.card .campaign h3 {
 font-size: 16px;
 padding-top: 20px;
 margin: 0 0 0 35px;
}
.content .campaign-holder.card .campaign h1 {
 font-size: 13px;
 padding-top: 20px;
 margin: 0 0 0 35px;
}
.content .campaign-holder.card .campaign .cgnDescription {
 padding-top: 10px;
 font-size: 11px;
}
.content .campaign-holder.card .campaign .cgnDescription {
...
.content .campaign-holder.card h2 + .campaign {
 border-top: none;
}
.content .campaign-holder.card h2 + .campaign .icon-new {
 display: block;
}
.content .main-col .just-in {
 width: 73px;
 height: 28px;
 background: transparent url("$baseUrl/shared/images/Icon_Just_In.png") center no-repeat;
 position: relative;
 left: -16px;
 color: #fff;
 font-size: 0.85em;
...
.content .main-col #store-location #map-address {
...
.content .main-col #store-location #map-address i.fa-map-marker {
   position: absolute;
   top: 8px;
   left: 12px;
   font-size: 20px;
}
.content .main-col #store-location {
   overflow: auto;
   display: block;
}
.content .main-col #store-location #map-address .nw-icon-location {
 position: absolute;
 font-size: 18px;
 left: 0;
}
.content .main-col #store-location #map-canvas {
 margin-bottom: 20px;
 position: relative;
 min-height: 350px;
}
.content .main-col #store-location .poweredByGoogle {
 position: absolute;
 margin-top: -15px;
 right: 25px;
 font-size: 0.85em;
...
.content .main-col #store-location .form-group {
 position: relative;
}
.content .main-col #store-location #startingPoint {
 padding-right: 35px;
}
.content .main-col #store-location .edit-address {
 display: none;
 border: none;
 outline: none;
 position: absolute;
...
.content .main-col h3.video-title {
 font-size: 12px;
 font-weight: bold;
 padding: 5px 0 0;
...
.content .main-col .video-thumb {
 margin-bottom: 10px;
 padding-bottom: 10px;
 border-bottom: dashed 1px #c0c0c0;
}
.content .main-col #enquiry-form .send-feedback {
 border-radius: 2px;
 color: #fff;
 text-decoration: none;
 font-size: 13px;
...
#body .catalog-grid .product-card .product-image-container{
   position: relative;
   height: 200px;
   width: 100%;
   margin-top: 10px;
}
#body .catalog-grid .product-card .product-summary {
   padding: 0 8px;
   font-size: 16px;
   line-height: 20px;
   text-align: center;
...
#body .catalog-grid .product-card .product-summary h3.product-name {
   text-transform: none;
   margin-top: 20px;
   margin-bottom: 10px;
   font-size: 16px;
...
#body .catalog-grid .product-card .product-summary h3.product-name span i.fa {
   margin-left: 5px;
   font-size: 26px;
   padding: 0;
   vertical-align: sub;
}
#body .catalog-grid .product-card .product-summary h3.product-name > a {
   font-weight: bold;
   cursor: pointer; 
}
#body .catalog-grid .product-card .product-summary .product-description {
  margin-bottom: 10px;
   font-size: 16px;
   line-height: 20px;
}
#body .catalog-grid .product-card .product-summary .product-price {
   margin: 15px 0;
}
|
#body .catalog-grid .product-card .product-summary .currency-symbol {
   margin-right: 4px;
}
|
#body .catalog-grid .product-card .product-summary .product-availibility {
   display: inline-block;
   border: none;
   position: static;
   padding: 0;
...
#body .catalog-grid .product-card .product-image-container amp-img img {
   object-fit: contain;
}
#body .catalog-grid .product-card .buy-now-card-link {
   font-size: 16px;
   padding: 8px;
   display: block;
   margin-top: 10px;
...
.nw-inner-wrapper #body .breadcrumb {
   padding: 8px 10px;
   border-bottom: dashed 1px #ccc;
   background: none;
   margin-bottom: 0;
}
table .item-image-placeholder-inner {
   height: 85px;
   width: 100%;
   border: 1px solid #909090;
   position: relative;
}
table .item-image-placeholder-inner img {
   object-fit: contain;
}
.nw-inner-wrapper #body .list-wrapper > table td {
   vertical-align: top;
}
.nw-inner-wrapper #body .list-wrapper table tr {
   position: relative;
}
.nw-inner-wrapper #body .breadcrumb {
   padding: 8px 10px;
...
.nw-inner-wrapper #body .breadcrumb a {
   text-transform: capitalize;
   cursor: pointer;
}
.nw-inner-wrapper #body .breadcrumb .separator {
   margin: 0 5px;
}
.nw-inner-wrapper #body .breadcrumb a {
   text-transform: capitalize;
}
.nw-inner-wrapper #body h2.seccat-name {
   font-size: 16px;
   font-weight: 600;
   border-bottom: solid 1px #ccc;
   padding: 5px 0 5px 10px;
}
.nw-inner-wrapper #body a.view-all {
   float: right;
   margin-top: -32px;
   margin-right: 5px;
}
.nw-inner-wrapper .item-image-placeholder a.buy-now-text-link, 
.nw-inner-wrapper .item-image-placeholder a.read-more {
   display: block;
   text-decoration: underline;
   margin-top: 4px;
   border-bottom: none;
...
.nw-inner-wrapper .item-image-placeholder .cta-link {
   padding: 0;
   margin: 4px 0 0;
   text-transform: none;
   font-weight: 400;
...
.nw-inner-wrapper .price-val-isolated.price-val, .nw-inner-wrapper td.price-val {
   text-align: right;
   padding-right: 10px;
}
.nw-inner-wrapper .item-inner h3 .item-price {
   float: right;
...
.nw-inner-wrapper .item-inner h3 .item-price span{
   color: #434342;
   font-size: 16px;
   line-height: 20px;
}
.nw-inner-wrapper .price-val {
   color: #434342;
   font-weight: bold;
}
.nw-inner-wrapper .item-inner h3 a, .nw-inner-wrapper #showcase-body h2 a {
   padding-left: 10px;
   color: rgb(0, 0, 0);
   font-size: 16px;
   font-weight: 700;
...
.nw-inner-wrapper .item-inner h3 a {
   float: left;
}
.nw-inner-wrapper a {
   cursor: pointer;
}
.nw-inner-wrapper .item-descr-summary, .nw-inner-wrapper .item-descr-full {
   margin-top: 5px;
   padding-left: 10px;
   display: block;
   border-bottom: none;
...
.nw-inner-wrapper .item-price-placeholder {
   margin: 10px 0;
}
.nw-inner-wrapper .item-inner .item-price-table {
   margin-left: 10px;
}
.nw-inner-wrapper .item-inner h3 {
   text-transform: none;
   padding-top: 0;
   margin-top: 0;
   height: 15px;
...
.nw-inner-wrapper .item-wrapper td{
  border-bottom: 1px dashed #c0c0c0;
  padding-top: 10px;
}
.nw-inner-wrapper #body a.view-all-bottom {
   display: block;
   text-align: center;
...
.nw-inner-wrapper #body a.view-all-bottom i {
   margin-left: 4px;
   vertical-align: bottom;
   font-size: 26px;
}
.overview-section-card h3.section-name {
   text-align: center;
   font-size: 16px;
}
...
#header.theme-content-bg.theme-border.show-on-filter, 
#body .list-wrapper.show-on-filter, #filtered-products-list.show-on-filter, #body .show-on-filter {
   display: block;
}
#header.theme-content-bg.theme-border.hide-on-filter, 
#body .list-wrapper.hide-on-filter, #filtered-products-list.hide-on-filter, .hide-on-filter,
#catalog .nw-inner-wrapper #body .list-wrapper .hide-on-filter, #body .nw-inner-wrapper .hide-on-filter {
   display: none;
}.filter_icon {
   border: 1px solid #c0c0c0;
   position: absolute;
...
.filterButtonsDiv.filterButtonsDiv-show{
   display: block;
}
#accordion {
   padding-left: 14px;
...
.m_filter_close {
   background: #f9f9f9 url(https://www.niftywindow.com/shared/images/Icon_Delete.png) no-repeat;
...
#accordion li span.criterionName {
   cursor: pointer;
   text-transform: uppercase;
   font-size: 14px;
   display: block;
   padding: 4px 0;
   background: url(/shared/images/arrow-desc.png) no-repeat right;
   background-size: 19px;
}
#accordion li .criterionValues {
   padding-top: 10px;
   padding-right: 4px;
   display: none;
}
#accordion li .criterionValues .criterionItem {
   cursor: pointer;
   font-size: 12px;
   color: #a0a0a0;
   padding: 2px 0;
...
#accordion li .criterionValues.openSubFilter {
   display: block;
}#catalog .other-sections-list {
   
}
#catalog .other-sections-list h2.other {
   padding: 8px 10px;
   margin-top: 20px;
   margin-bottom: 10px;
   font-weight: 500;
}
#catalog .other-sections-list .header-link-bottom-lst {
   display: block;
   float: none;
   line-height: 30px;
   padding-left: 10px;
}
#catalog .other-sections-list .header-link {
   padding: 0 5px;
   height: 30px;
   font-weight: 900;
}#catalog #header {
...
#catalog #header #pagination-wrapper {
   position: relative;
   bottom: 10px;
   height: 40px;
   display: table;
...
.filter-selector [option] .hide-tick{
   display: none;
}
.filter-selector [option][selected] .hide-tick{
   display: block;
   float: right;
}
...
.footer .footer-content p.poweredBy, .footer .footer-content p.copyright {
   text-align: center;
   padding: 10px;
   margin: 0;
}
...
.footer .footer-content p.poweredBy amp-img.powered-by-image {
   margin-right: 10px;
   transform: translateY(25%);
}
.footer .footer-content p.poweredBy span {
   margin-left: 10px;
}
.footer-snm {
   text-align: center;
...
.lightbox .form-wrapper .lightbox-header {
   padding: 0 15px;
   border-bottom: 1px solid #e5e5e5;
   min-height: 16.428571429px;
   margin-bottom: 30px;
}
.lightbox .close-reserve-lightbox {
   position: absolute;
   top: 25px;
   right: 25px;
}
.lightbox-heading .close-my-lightbox {
   position: absolute;
   top: 0;
   right: 0;
   padding: 10px;
}
.lightbox .form-wrapper .modal-body {
   position: relative;
   padding: 20px;
}
.lightbox .form-wrapper form .form-group {
   margin-bottom: 25px;
   position: relative;
   width: 100%;
} 
.lightbox .form-wrapper form .form-group input {
   box-sizing: border-box;
   display: block;
   position: relative;
   width: 100%;
...
</amp-state><!--[if lt IE 9 ]><div class="useRealBrowser"><div class="container"><p class="warning">Hmm. Your browser version needs a makeover. These pages are not supported on older browsers (Internet Explorer 8 and below) hence please upgrade your current browser or switch to another browser.</p><div class="upgrade"><a href="http://www.google.com/chrome/" target="_blank" class="chrome">Google Chrome</a><span> | </span><a href="https://www.mozilla.org/en-US/firefox/products/" target="_blank" class="firefox">Mozilla Firefox</a><span> | </span><a href="http://www.opera.com/download" target="_blank" class="opera">Opera</a><span> | </span><a href="http://windows.microsoft.com/en-IN/internet-explorer/download-ie" target="_blank" class="ie">Internet Explorer 11</a></div><p class="note">Outdated browsers such as Internet Explorer 8 don't follow the web standards, are full of bugs, 
and have security issues as virus and malware. It also affects the quality of websites rendering.</p></div></div><![endif]--><amp-analytics>
 <script type="application/json">
   {
     "requests": {
...
<form action="/amp/marathahalli-bangalore/4833112707825664/catalog" method="get" target="_top"><label for="search-box">Search</label><input id="search-box" type="text" placeholder="Search products" style="right: 0" name="keyword" value="" class="theme-border theme-body-text"><i aria-hidden="true" class="fa fa-search"></i></form></div>
...
Featured
	...
	<div class="product-card item-hover-bg theme-border" title="&#123;&#123;description&#125;&#125;" data-nwlistingid="&#123;&#123;nwListingId&#125;&#125;" itemscope="itemscope" itemtype="http://schema.org/Product" data-is-un-available="&#123;&#123;isUnAvailable&#125;&#125;">
      ...
      <div class="product-summary">
			...
			<div class="product-price">
				<div itemscope="itemscope" itemtype="http://schema.org/Offer" class="price-val-isolated">
					<span itemprop="priceCurrency" class="theme-heading-text currency-symbol">&#x20B9;</span>
					<span itemprop="price" class="theme-heading-text">&#123;&#123;price&#125;&#125;</span>
					<label class="label-avail brand-color-text product-availability mobile-only">
						&#123;&#123;#isUnAvailable&#125;&#125;<span class="availibility-icon"><i class="fa fa-check-circle-o" [class]="&#123;&#123;isUnAvailable&#125;&#125;==true?'fa fa-close-circle-o':'fa fa-check-circle-o'"></i></span>&#123;&#123;/isUnAvailable&#125;&#125;
                      &#123;&#123;^isUnAvailable&#125;&#125;<span class="availibility-icon"><i class="fa fa-check-circle-o"></i></span>&#123;&#123;/isUnAvailable&#125;&#125;
						<span [text]="&#123;&#123;isUnAvailable&#125;&#125;?'Unavailable':'Available'">Available</span>
					</label>
				</div>
			</div>
		</div>
  ...
  <amp-list-load-more load-more-loading><i class="fa fa-spinner fa-spin"></i></amp-list-load-more>
